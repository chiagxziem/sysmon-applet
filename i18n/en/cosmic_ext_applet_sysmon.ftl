...
enable-download-value = Show download value
enable-upload-value = Show upload value
enable-write-value = Show write value
enable-read-value = Show read value
...
change-combined-value-size = Combined value size
